...
const cancelAllOrders = async (orders) => {
...
const buyStock = async (stockCode, amount) => {
    await submitOrder(stockCode, amount, BUY);
};

const sellStock = async (stockCode, amount) => {
    await submitOrder(stockCode, amount, SELL);
};

const dumpStock = async (stockCode) => {
